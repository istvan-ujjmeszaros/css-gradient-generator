...
/*global $,jQuery,QRCode,SyntaxHighlighter,tinycolor,console: true */
...
"use strict";
    ...
    function bindevents() {
        ...
        elements.exportalltextarea.on("focus", function(e) {
            var $this = $(this);
    ...
    function updateControllerStates($this) {
            var name = $this.data("name"),
                value = $this.data("value"),
                configtoggle = $this.data("config-toggle");
    ...
    function updateToolbar() {
        ...
        if (typeof window.history.pushState === 'function') {
            history.replaceState({}, '', window.location.pathname + "?" + currentgradient);
        }
